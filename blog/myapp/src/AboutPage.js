...
const AboutPage = () => {
    return (
        <div className="App">
            <img src="/blog/20231017_18_24_0.png" alt="firstone" className="header-image" />
            ...
            <div className="paragraph">
                <p>
                    ...
                    <a href="https://twitter.com/area51439213784" target="_blank" rel="noopener noreferrer">
                        <img src="/blog/icons8-twitter-48.png" alt="twitter" className="sns-icon" />
                    </a>
                    <a href="https://www.instagram.com/shintaro20090317_2/" target="_blank" rel="noopener noreferrer">
                        <img src="/blog/icons8-instagram-48.png" alt="instagram" className="sns-icon" />
                    </a>
                    <a href="https://github.com/Shintaro060776/dom" target="_blank" rel="noopener noreferrer">
                        <img src="/blog/icons8-github-48.png" alt="github" className="sns-icon" />
                    </a>
                </p>
            </div>
        </div>
